...
# Sentiment Analysis
* 감성분석에는 LSTM 모델을 이용하였습니다.
* 학습 방법
  * 전체 데이터 393,562개의 데이터에서 training set과 validation set의 비율을 8 : 2로 두어 성능을 평가하였습니다.
  * 최종 예측하는 것은 현재 감정에 대한 긍/부정으로, 데이터 불균형 문제가 없었기 때문에 성능 평가는 정확도(Accuracy)를 기준으로 판단하였습니다.
* 감정분석 성능 평가
